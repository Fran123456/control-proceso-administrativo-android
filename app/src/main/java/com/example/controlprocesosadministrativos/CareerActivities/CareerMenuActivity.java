...
public class CareerMenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuList = Help.getMenusCareer(); //obtenemos el menu
        recyclerView = (RecyclerView)findViewById(R.id.recycleMenuCareer);
